...
public class BackupProfileDialog implements IProfileDialog {
	...
	public void createDialogArea(Composite parent, Profile profile) {
		...
		createTargetServerInputs(parent, profile);
		createTableArea(parent, profile);
	}
	
	private void createTargetServerInputs(Composite parent, Profile profile) 
	{
		...
		if (profile != null && profile.getProfileData() != null 
				&& profile.getProfileData().get(BackupConstants.PARAMETERS.USE_SSH_KEY) != null) {
			btnCheckSSH.setSelection((boolean) profile.getProfileData().get(BackupConstants.PARAMETERS.USE_SSH_KEY));
		}
		...
		if (profile != null && profile.getProfileData() != null) {
			txtUsername.setText(profile.getProfileData().get(BackupConstants.PARAMETERS.USERNAME).toString());
		}
		...
		if (profile != null && profile.getProfileData() != null) {
			txtPassword.setText(profile.getProfileData().get(BackupConstants.PARAMETERS.PASSWORD).toString());
		}
		...
		if (profile != null && profile.getProfileData() != null) {
			txtDestHost.setText(profile.getProfileData().get(BackupConstants.PARAMETERS.DEST_HOST).toString());
		}
		...
		if (profile != null && profile.getProfileData() != null) {
			txtDestPort.setText(profile.getProfileData().get(BackupConstants.PARAMETERS.DEST_PORT).toString());
		}
		...
		if (profile != null && profile.getProfileData() != null 
				&& profile.getProfileData().get(BackupConstants.PARAMETERS.USE_LVM) != null) {
			btnCheckLVM.setSelection((boolean) profile.getProfileData().get(BackupConstants.PARAMETERS.USE_LVM));
		}
		new Label(composite, SWT.NONE);
	}
	...
	private void createTable(final Composite parent, Profile profile) {
		...
		if (profile != null && profile.getProfileData() != null
				&& profile.getProfileData().get(BackupConstants.PARAMETERS.BACKUP_LIST_ITEMS) != null) 
		{	
			ArrayList<LinkedHashMap<String, Object>> list = (ArrayList<LinkedHashMap<String, Object>>) profile
					.getProfileData().get(BackupConstants.PARAMETERS.BACKUP_LIST_ITEMS);
